...
public class SimpleDemo implements IMsgHandlerFace {
	...
	public String textMsgHandle(BaseMsg msg) {
		...
		for (String gs : groupIdlist) {
			
			System.out.println("group id = " + gs);
//			public static JSONArray getMemberListByGroupId(String groupId)
			JSONArray memList =  WechatTools.getMemberListByGroupId(gs) ;
			for (Object o : memList) {
				System.out.println(JSON.toJSONString(o));
				Map<String,String> map1 = (Map<String,String>)JSON.parse(JSON.toJSONString(o));
				
				System.out.println("群昵称:" + map1.get("DisplayName") + " 本身昵称:" + map1.get("NickName"));
			}

		}
		 
		List<String> glist = WechatTools.getGroupNickNameList();
		for (String s : glist) {
			
			System.out.println("group nikename = " + s);
